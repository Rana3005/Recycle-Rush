...
public class HealthHotbar : MonoBehaviour
{
    public GameObject heartPrefab;
    //public float health, maxHealth;
    public PlayerHealth player;

    List<HealthHearts> hearts = new List<HealthHearts>();         //list of hearts and update state
    ...
    public void RemoveHearts(){
        ...
        hearts = new List<HealthHearts>();               //Removes heart gameobjects under the health bar parent in canavs
    }
}
